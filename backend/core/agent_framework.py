...
"""
    ...
    def _create_graph(self) -> StateGraph:
        ...
        # Set edge conditions
        workflow.set_edge_filter("analyze_query", "handle_info_request", lambda x: x['intent'] == 'info')
        workflow.set_edge_filter("analyze_query", "confirm_action", lambda x: x['intent'] in ['run', 'analyze'])
        workflow.set_edge_filter("confirm_action", "execute_action", lambda x: x.get('confirmed', False))
        workflow.set_edge_filter("confirm_action", END, lambda x: not x.get('confirmed', False))
